...
# factor1a_4 <- factor1a_4 %>%
#   mutate(factor1a_4_score = rowMeans(., na.rm = TRUE))

# factor1a_4 <- factor1a_4 %>%
#   rowwise() %>%
#   mutate(factor1a_4_score = mean(c_across(everything())))

# factor1a_4 <- factor1a_4 %>%
#   rowwise() %>%
#   mutate(factor1a_4_score = mean(select(., being_free_of_doubt:being_overwhelmed_r)))
